...
//**********FILTROS BÚSQUEDAS SIMPLES EN TODAS LAS COLUMNAS****************/
...
/*************CHECKBOX******************************/
var codanterior = "";
jQuery("#bunidad").change(function () {
    
    if (this.checked) {
        $("#bcarreta").prop("checked", false);
        $("#codcarreta").attr("readonly", true);
        codanterior = $('#codcarreta').val();
        $('#codcarreta').val("");

        } else {
        $("#bcarreta").prop("checked", true);
        $("#codcarreta").attr("readonly", false);
        $('#codcarreta').val(codanterior);
        }
...
jQuery("#bcarreta").change(function () {

    if (this.checked) {
        $("#bunidad").prop("checked", false);
        $("#codcarreta").attr("readonly", false);
        $('#codcarreta').val(codanterior);
    } else {
        $("#bunidad").prop("checked", true);
        $("#codcarreta").attr("readonly", true);
        codanterior = $('#codcarreta').val();
        $('#codcarreta').val("");
    }
...
/*************RADIO******************************/
jQuery("#sw_lang_left").change(function () {
    if (this.checked) {
        $("#sw_lang_right").prop("checked", false);
        $("#fec_ret").hide();
    } 
});

jQuery("#sw_lang_right").change(function () {
    if (this.checked) {
        $("#sw_lang_left").prop("checked", false);
        $("#fec_ret").show();
    } 
